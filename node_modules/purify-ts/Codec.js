...
exports.Codec = {
    ...
    interface: function (properties) {
        ...
        return {
            decode: decode,
            encode: encode,
            unsafeDecode: function (input) { return decode(input).mapLeft(Error).unsafeCoerce(); },
            schema: function () {
...
var record = function (keyCodec, valueCodec) {
    return exports.Codec.custom({
        decode: function (input) {
            var e_5, _a;
            var result = {};
...
var exactly = function () {
    ...
    for (var _i = 0; _i < arguments.length; _i++) {
        expectedValues[_i] = arguments[_i];
    }
    return exports.Codec.custom({
        decode: function (input) {
        ...
        encode: Function_1.identity,
        schema: function () { return ({
            oneOf: expectedValues.map(function (value) { return ({
                type: typeof value,
                enum: [value]
            }); })
        }); }
...
var intersect = function (t, u) {
    return exports.Codec.custom({
        ...
        encode: function (input) {
            var valuet = t.encode(input);
            var valueu = u.encode(input);
            return isObject(valuet) && isObject(valueu)
...
var map = function (keyCodec, valueCodec) {
    return exports.Codec.custom({
        decode: function (input) {
            return exports.array(exports.tuple([keyCodec, valueCodec]))
                .decode(input)
                .map(function (pairs) { return new Map(pairs); });
        },
        encode: function (input) {
            return Array.from(input.entries()).map(function (_a) {
